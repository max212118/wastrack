...
user3 = User.create!(first_name: 'Eli', last_name: 'Renucci', email:'eli.renucci@gmail.com', password: '123456',employee: 'AZERT',type: 'city_employee', admin: false, city_hall_id: city_hall_megeve.id, phone_number: '0664929925')
user4 = User.create!(first_name: 'Kosta', last_name: 'Cucuz', email:'kosta.cucuz@gmail.com', password: '123456',employee: 'YUIOP', type: 'city_employee', admin: false, city_hall_id: city_hall_megeve.id, phone_number: '0664929926')
user5 = User.create!(first_name: 'Phillipine', last_name: 'Doligez', email:'phillipine.doligez@gmail.com', password: '123456',employee_id: 'QSDFG',type: 'collector', admin: false, city_hall_id: city_hall_megeve.id, phone_number: '0664929927')
user6 = User.create!(first_name: 'Francois', last_name: 'Robino', email:'francois.robino@gmail.com', password: '123456',employee_id: 'GHJKL',type: 'collector', admin: false, city_hall_id: city_hall_megeve.id, phone_number: '0664929928')
user7 = User.create!(first_name: 'Romain', last_name: 'Tarnaud', email:'romain.tarnaud@gmail.com', password: '123456',employee_id: 'WXCVB',type: 'collector', admin: false, city_hall_id: city_hall_megeve.id, phone_number: '0664929929')
user8 = User.create!(first_name: 'Louis', last_name: 'Quemard', email:'louis.quemard@gmail.com', password: '123456',employee_id: 'JKLMD',type: 'collector', admin: false, city_hall_id: city_hall_megeve.id, phone_number: '0664929430')
